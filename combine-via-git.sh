...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-xfce-theme-vimix"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-xfce-theme-vimix/iso-profile
"
echo
